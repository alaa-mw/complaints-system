...
//   const { data: complaintDetails, isLoading } = useFetchData<details>(
...
//   //           {error?.message || 'فشل في تحميل بيانات الشكوى'}
//   //         </Alert>
...
//               >
//                 <Chat />
//                 الطلبات والردود ({complaint?.requestsAndReplies.length})
//               </Typography>
...
//           {complaint?.employee_notes && complaint?.employee_notes.length > 0 && (
...
//                 >
//                   <Note />
//                   ملاحظات الموظفين ({complaint.employee_notes.length})
//                 </Typography>
